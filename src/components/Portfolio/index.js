        ...
        <div className="portfolio-container">
          ...
          <div className="portfolio-item">
              ...
              <div className="portfolio-item-text">
                ...
                <span className="tech-stack"><p><b>Azure | MySQL</b></p><span className="bigger-icons"><FontAwesomeIcon icon={faPython} color="red" /><FontAwesomeIcon icon={faNode} color="green" /><FontAwesomeIcon icon={faReact} color="aqua" /><FontAwesomeIcon icon={faJs} color="#FFFF00" /><FontAwesomeIcon icon={faSass} color="hotpink" /></span></span>
            ...
            <div className="portfolio-item">
              ...
              <div className="portfolio-item-text">
                ...
                <p>A C++ shell interface that seamlessly manages multiple user commands in parallel processes. Effortless command pairs with pipes for reliable communication and data flow. Redefine output destinations with precision and navigate complex workflows efficiently. A user-centric design that supports commands with arguments, ensuring a tailored experience.</p>
                {/* Tech used displaying logos for each */}
